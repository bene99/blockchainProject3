...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, ConsumerRole, RetailerRole {
  ...
  */
  ...
  // had to change the function since I inherit from the Ownable contract
  ...
  onlyFarmer()
  {
    ...
    productID: productId, productNotes:_productNotes,productPrice:1,itemState:State.Harvested,distributorID:address(0),
    retailerID:address(0),consumerID:address(0)} );
    // Increment sku
    sku = sku + 1;
